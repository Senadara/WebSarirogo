        ...
        <div class="bg-white rounded-2xl shadow-xl border border-bg-3 p-6 sm:p-8">
            ...
            <form action="#" method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input 
                            ...
                            class="w-full pl-10 pr-4 py-3 border border-bg-4 rounded-xl text-text-5 placeholder-text-2
                ...
                <div>
                    ...
                    <div class="relative" x-data="{ showPassword: false }">
                        ...
                        <input 
                            ...
                            required
                            placeholder="••••••••"
                            class="w-full pl-10 pr-12 py-3 border border-bg-4 rounded-xl text-text-5 placeholder-text-2
                                   focus:outline-none focus:ring-2 focus:ring-primary-3 focus:border-transparent
                                   transition duration-200 text-sm sm:text-base"
                        >
                        <button 
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                    ...
                    <a href="#" class="text-sm text-primary-4 hover:text-primary-5 font-medium transition">
                        Lupa password?
                    </a>
                </div>
