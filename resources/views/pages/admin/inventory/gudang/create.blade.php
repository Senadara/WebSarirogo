...
@section('content')
<div x-data="createItemForm()" class="flex bg-gray-50 min-h-screen overflow-x-hidden">
    ...
    <main class="flex-1 p-4 lg:p-8 lg:ml-72 max-w-full">
        ...
        <div class="flex items-center justify-between mb-4 lg:hidden">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h1 class="text-lg font-bold text-gray-900">Tambah Barang</h1>
        ...
        <div class="flex flex-wrap items-center justify-between gap-3 mb-6">
            <div class="flex items-center gap-2 text-sm text-gray-600">
                ...
                <span>/</span>
                <span class="font-semibold text-gray-900">Tambah Barang</span>
            </div>
        ...
        <div class="mb-6 lg:mb-8">
            <h1 class="text-2xl lg:text-3xl font-bold text-gray-900 mb-2">Form Tambah Barang Baru</h1>
            <p class="text-gray-600 hidden lg:block">
                Lengkapi informasi barang untuk menambahkan item baru ke gudang.
            </p>
        </div>
                ...
                <form @submit.prevent="submitForm">
                        ...
                        <div class="bg-white rounded-2xl border shadow-sm p-6 lg:p-8">
                            <div class="flex items-center gap-3 mb-6">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500">Data dasar barang yang akan disimpan</p>
                                </div>
                            </div>
                    ...
                    <div x-show="currentStep === 4" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 translate-x-4" x-transition:enter-end="opacity-100 translate-x-0">
                        <div class="bg-white rounded-2xl border shadow-sm p-6 lg:p-8">
                            <div class="flex items-center gap-3 mb-6">
                                ...
                                <div>
                                    <h2 class="text-xl font-bold text-gray-900">Review & Simpan</h2>
                                ...
                                <div class="bg-emerald-50 rounded-xl p-5 border border-emerald-100">
                                    ...
                                    <div class="space-y-2 text-sm">
                                        ...
                                        <div class="flex justify-between">
                                            ...
                                            <span class="font-medium text-gray-900" x-text="(form.stokMasuk || 0) + ' ' + (form.satuan || '')"></span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="mt-6 p-4 bg-amber-50 rounded-xl border border-amber-200">
                                <div class="flex items-start gap-3">
                                    ...
                                    <div>
                                        <p class="text-sm font-medium text-amber-800">Pastikan semua data sudah benar</p>
                                        <p class="text-xs text-amber-700 mt-1">Data yang sudah disimpan masih dapat diubah melalui menu Edit.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="flex flex-col sm:flex-row items-center justify-between gap-4 mt-6 bg-white rounded-2xl border shadow-sm p-4 lg:p-6">
                        <button type="button" 
                            ...
                            <span x-text="currentStep > 1 ? 'Sebelumnya' : 'Kembali'"></span>
                        </button>
...
function createItemForm() {
    return {
        ...
        currentStep: 1,
        stepDescriptions: [
            'Masukkan data dasar barang seperti nama, kategori, dan informasi stok.',
            'Lengkapi detail spesifikasi teknis dan informasi harga barang.',
            'Tambahkan informasi supplier dan lokasi penyimpanan.',
