                ...
                <div class="lg:col-span-3 space-y-6">
                    ...
                    <div class="bg-white rounded-xl md:rounded-2xl p-4 md:p-6 shadow-sm border border-gray-100">
                        <div class="flex items-center gap-2 mb-4">
                            ...
                            <h3 class="text-base md:text-lg font-bold text-gray-900">Rincian Insiden</h3>
                        </div>
                        
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4">
                            <div class="bg-gray-50 rounded-xl p-3 md:p-4">
                                <p class="text-[10px] md:text-xs text-gray-500 uppercase tracking-wide mb-1">Kategori Insiden</p>
                                <p class="text-sm md:text-base font-semibold text-primary-4">Kesehatan Ayam</p>
                            </div>
                            <div class="bg-gray-50 rounded-xl p-3 md:p-4">
                                <p class="text-[10px] md:text-xs text-gray-500 uppercase tracking-wide mb-1">Tingkat Keparahan</p>
                                <p class="text-sm md:text-base font-semibold text-primary-4">Sedang</p>
                            </div>
                            <div class="bg-gray-50 rounded-xl p-3 md:p-4">
                                <p class="text-[10px] md:text-xs text-gray-500 uppercase tracking-wide mb-1">Hewan Terdampak</p>
                                <p class="text-sm md:text-base font-semibold text-primary-4">A12</p>
                            </div>
                            <div class="bg-gray-50 rounded-xl p-3 md:p-4">
                                <p class="text-[10px] md:text-xs text-gray-500 uppercase tracking-wide mb-1">Estimasi Kerugian</p>
                                <p class="text-sm md:text-base font-semibold text-primary-4">-</p>
                            </div>
                        </div>
                    </div>
                     ...
                     <div class="bg-white rounded-xl md:rounded-2xl p-4 md:p-6 shadow-sm border border-gray-100">
                        <div class="flex items-center gap-2 mb-3">
                            ...
                            <h3 class="text-base md:text-lg font-bold text-gray-900">Rencana Tindak Lanjut</h3>
                        </div>
                        <p class="text-xs md:text-sm text-gray-600 bg-gray-50 rounded-lg p-3 italic">
                            Sudah diberikan obat dan isolasi pada ayam yang terdampak.
                        </p>
                    </div>
                    ...
                    <div class="bg-white rounded-xl md:rounded-2xl p-4 md:p-6 shadow-sm border border-gray-100">
                        ...
                        <p class="text-xs md:text-sm text-gray-600 bg-gray-50 rounded-lg p-3 italic">
                          terlihat 15 ekor ayam terdampak.
                        </p>
                    </div>
                </div>
                ...
                <div class="lg:col-span-2">
                    <div class="bg-white rounded-xl md:rounded-2xl p-4 md:p-6 shadow-sm border border-gray-100 lg:sticky lg:top-6">
                        <div class="flex items-center gap-2 mb-4">
                            ...
                            <h3 class="text-base md:text-lg font-bold text-gray-900">Bukti Insiden</h3>
                        </div>
