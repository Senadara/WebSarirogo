{{-- Form Step 2 - Laporan Harian: Tentukan Barang --}}
...
<div x-data="{ 
    ...
    <main class="flex-1 p-4 md:p-6 lg:ml-72">
        ...
        <x-form.stepper 
            ...
            description="Tambahkan barang dari inventory yang digunakan beserta jumlah pemakaian."
        />
                        ...
                        <div class="mb-5">
                            <div class="flex items-center justify-between mb-3">
                                ...
                                <span 
                                    ...
                                    x-text="selectedItems.length + ' Item'"
                                ></span>
                            </div>
        ...
        <div class="bg-white rounded-xl md:rounded-2xl border border-gray-100 p-4 md:p-6 shadow-sm">
            <div class="flex flex-col sm:flex-row items-center gap-3">
                ...
                <a 
                    href="{{ route('admin.ayam.laporan.harian.step3') }}"
