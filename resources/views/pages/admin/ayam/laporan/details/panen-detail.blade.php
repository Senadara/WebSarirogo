...
<div x-data="{ open: false }" class="flex bg-white min-h-screen">
    ...
    <main class="flex-1 p-4 md:p-6 lg:ml-72">
        ...
        {{-- Title --}}
        <h1 class="text-2xl md:text-4xl font-bold mb-4 md:mb-6 hidden lg:block">Detail Laporan Panen</h1>
                ...
                <div class="lg:col-span-3 space-y-6">
                    ...
                    <div class="bg-white rounded-xl md:rounded-2xl p-4 md:p-6 shadow-sm border border-gray-100">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4">
                            ...
                            <div class="bg-gray-50 rounded-xl p-3 md:p-4">
                                <p class="text-[10px] md:text-xs text-gray-500 uppercase tracking-wide mb-1">Total Panen</p>
                                <p class="text-sm md:text-base font-semibold text-primary-4">200 kg</p>
                            </div>
                            <div class="bg-gray-50 rounded-xl p-3 md:p-4">
                    ...
                    <div class="bg-white rounded-xl md:rounded-2xl p-4 md:p-6 shadow-sm border border-gray-100">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex items-center justify-between py-2.5 md:py-3 px-3 md:px-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition">
                                <div class="flex items-center gap-2 md:gap-3">
                                    <div class="w-8 h-8 md:w-10 md:h-10 rounded-lg bg-white border flex items-center justify-center">
                                        <img src="/assets/icons/ayam.svg" class="w-5 h-5 md:w-6 md:h-6" alt="item">
                                    </div>
                                    <div>
                                        <p class="text-xs md:text-sm font-medium text-gray-900">Grade A</p>
                                    </div>
                                </div>
                            ...
                            <div class="flex items-center justify-between py-2.5 md:py-3 px-3 md:px-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition">
                                <div class="flex items-center gap-2 md:gap-3">
                                    ...
                                    <div>
                                        <p class="text-xs md:text-sm font-medium text-gray-900">Grade B</p>
                                    </div>
                                </div>
                                <div class="text-right">
                                    <span class="inline-flex items-center gap-1 bg-primary-3 text-white text-xs md:text-sm font-bold px-3 py-1 rounded-full">
                        ...
                        <div class="flex items-center justify-between py-2.5 md:py-3 px-3 md:px-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition">
                            <div class="flex items-center gap-2 md:gap-3">
                                ...
                                <div>
                                    <p class="text-xs md:text-sm font-medium text-gray-900">Grade C</p>
                                </div>
                            </div>
                            <div class="text-right">
                                <span class="inline-flex items-center gap-1 bg-primary-3 text-white text-xs md:text-sm font-bold px-3 py-1 rounded-full">
                    ...
                    <div class="bg-white rounded-xl md:rounded-2xl p-4 md:p-6 shadow-sm border border-gray-100">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex items-center justify-between py-2.5 md:py-3 px-3 md:px-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition">
                                <div class="flex items-center gap-2 md:gap-3">
                                    <div>
                                        <p class="text-xs md:text-sm font-medium text-gray-900">Mayoritas kualitas A, cocok untuk pasar premium.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
