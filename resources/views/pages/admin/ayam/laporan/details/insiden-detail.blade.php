...
<div x-data="{ open: false }" class="flex bg-white min-h-screen">
    ...
    <main class="flex-1 p-4 md:p-6 lg:ml-72">
        ...
        <div class="flex items-center gap-3 mb-4 md:mb-6 lg:hidden">
            ...
            <h1 class="text-base md:text-lg font-bold">Detail Laporan Insiden</h1>
        </div>
        ...
        {{-- Title --}}
        <h1 class="text-2xl md:text-4xl font-bold mb-4 md:mb-6 hidden lg:block">Detail Laporan Insiden</h1>
        ...
        <div class="bg-gradient-to-br from-primary-1/50 to-white rounded-2xl md:rounded-3xl border border-primary-2/50 p-4 md:p-8 mb-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-5 gap-6 md:gap-8">
                ...
                <div class="lg:col-span-3 space-y-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4">
                            ...
                            <div class="bg-gray-50 rounded-xl p-3 md:p-4">
                                ...
                                <div class="flex items-center gap-2">
                                    <div class="w-6 h-6 md:w-8 md:h-8 rounded-full bg-primary-3 flex items-center justify-center text-white text-xs md:text-sm font-bold">BS</div>
                                    <p class="text-sm md:text-base font-semibold text-gray-900">Bu Sari</p>
                                </div>
                            </div>
                    ...
                    {{-- Informasi Insiden Card --}}
                    <div class="bg-white rounded-xl md:rounded-2xl p-4 md:p-6 shadow-sm border border-gray-100">
                        <div class="flex items-center gap-2 mb-4">
                            <div class="w-8 h-8 rounded-lg bg-red-1 flex items-center justify-center">
                                <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                </svg>
                            </div>
                            <h3 class="text-base md:text-lg font-bold text-gray-900">Informasi Insiden</h3>
                        </div>

                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4">
                            <div class="bg-gray-50 rounded-xl p-3 md:p-4">
                                <p class="text-[10px] md:text-xs text-gray-500 uppercase tracking-wide mb-1">Kategori Insiden</p>
                                <p class="text-sm md:text-base font-semibold text-primary-4">Guntur</p>
                            </div>
                            <div class="bg-gray-50 rounded-xl p-3 md:p-4">
                                <p class="text-[10px] md:text-xs text-gray-500 uppercase tracking-wide mb-1">Tingkat Keparahan</p>
                                <p class="text-sm md:text-base font-semibold text-gray-900">Sedang</p>
                            </div>
                             <div class="bg-gray-50 rounded-xl p-3 md:p-4 md:col-span-2">
                                <p class="text-[10px] md:text-xs text-gray-500 uppercase tracking-wide mb-1">Estimasi Kerugian</p>
                                <p class="text-sm md:text-base font-semibold text-gray-900">20 Ekor</p>
                            </div>
                        </div>
                    </div>

                    {{-- Tindakan dan Follow Up --}}
                    <div class="bg-white rounded-xl md:rounded-2xl p-4 md:p-6 shadow-sm border border-gray-100">
                        <div class="flex items-center gap-2 mb-4">
                            <div class="w-8 h-8 rounded-lg bg-primary-1 flex items-center justify-center">
                                <svg class="w-4 h-4 text-primary-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <h3 class="text-base md:text-lg font-bold text-gray-900">Tindakan dan Follow Up</h3>
                        </div>

                        <div class="space-y-2">
                             <div class="bg-gray-50 rounded-xl p-3 md:p-4">
                                <p class="text-[10px] md:text-xs text-gray-500 uppercase tracking-wide mb-1">Rencana Tindak Lanjut</p>
                                <p class="text-sm md:text-base font-semibold text-gray-900">kandang harus di kedapkan suara lagi</p>
                            </div>
                            <div class="bg-gray-50 rounded-xl p-3 md:p-4">
                                <p class="text-[10px] md:text-xs text-gray-500 uppercase tracking-wide mb-1">Catatan</p>
                                <p class="text-sm md:text-base font-semibold text-gray-900">segera dilaksanakan</p>
                            </div>
